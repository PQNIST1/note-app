            ...
            >
                <View style={styles.BackgroundContainer}>
                    <View style={styles.container}>
                        <Text style={styles.title}>would you like to delete this note ({selectedInvoice.invoice_customerid})?</Text>
                        <Text style={styles.subTitle}>If you are sure to delete this note then click Agree
